...
Congratulations, your background passed. Look out for an email from Quest Diagnostics(any QUEST location should suffice), this will have the information you need for your pre-employment drug test. Also be sure to login to the Amazon portal(where you started the background) and watch your seven onboarding videos. When both of these are completed, please reach out to us at $stationPhone to schedule a date for you to start your paid classes.
